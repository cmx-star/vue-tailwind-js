<template>
  <div class="p-6">
    <div class="mb-6">
      ...
      <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">全局参数配置与系统优化</p>
    </div>
    ...
    <div class="space-y-6">
      ...
      >
        ...
        >
          <CompIcon name="palette" :size="20" class="text-blue-600 dark:text-blue-400" />
          外观设置
        </h2>
        ...
        <div class="space-y-6">
          ...
          >
            <div class="flex-1">
              <h3 class="text-base font-medium text-gray-900 dark:text-white mb-1">暗色模式</h3>
              <p class="text-sm text-gray-500 dark:text-gray-400">切换系统的明暗主题</p>
            </div>
            <button
          ...
          <!-- 主题样式 -->
          <div class="py-4">
            <h3 class="text-base font-medium text-gray-900 dark:text-white mb-3">主题样式</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">选择您喜欢的主题配色方案</p>
      ...
      >
        <h2
          class="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center gap-2"
        >
          <CompIcon name="language" :size="20" class="text-blue-600 dark:text-blue-400" />
          语言设置
        </h2>

        <div class="py-4">
          <h3 class="text-base font-medium text-gray-900 dark:text-white mb-3">界面语言</h3>
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">选择系统显示语言</p>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-md">
            ...
            >
              <div class="flex items-center gap-2">
                <CompIcon v-if="currentLocale === lang.value" name="check-circle" :size="16" />
      ...
      >
        <h2
          class="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center gap-2"
        >
          <CompIcon name="cog" :size="20" class="text-blue-600 dark:text-blue-400" />
          常规配置
        </h2>
        <p class="text-gray-600 dark:text-gray-400">系统标题、Logo 及域名映射设置...</p>
      </div>
      ...
      >
        <h2
          class="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center gap-2"
        >
          <CompIcon name="shield-halved" :size="20" class="text-blue-600 dark:text-blue-400" />
          安全选项
        </h2>
        <p class="text-gray-600 dark:text-gray-400">IP 白名单、访问控制及审计频率...</p>
      </div>
    </div>
  </div>
</template>
