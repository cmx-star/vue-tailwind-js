<template>
  <div class="relative overflow-x-auto bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700" :style="maxHeight ? `max-height: ${maxHeight}; overflow-y: auto;` : ''">
    <table class="w-full text-sm text-left rtl:text-right text-gray-700 dark:text-gray-400">
      <thead class="text-sm text-gray-700 dark:text-gray-400 bg-gray-100 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 sticky top-0 z-10">
        <tr>
          ...
          >
            <div v-if="column.sortable" class="flex items-center cursor-pointer" @click="handleSort(column.key)">
...
export default {
  ...
  methods: {
    rowClasses(index) {
      ...
      const hoverClass = this.hoverable ? 'hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors' : '';
