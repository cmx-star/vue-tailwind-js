  ...
  <div :class="containerClass">
    ...
    <div :class="inputWrapperClass">
      ...
      <div v-if="prefixIcon || prefixText" :class="prefixClasses">
        <svg v-if="prefixIcon" class="w-4 h-4 text-gray-700 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" :d="prefixIcon"/>
        </svg>
...
export default {
  ...
  computed: {
    ...
    inputClasses() {
      ...
      const paddingClasses = this.prefixIcon ? 'ps-9 pe-3 py-2.5' : this.prefixText ? 'rounded-none rounded-e-lg px-3 py-2.5' : 'px-3 py-2.5';
