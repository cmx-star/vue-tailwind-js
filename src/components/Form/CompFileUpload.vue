<template>
  <div class="flex items-center justify-center w-full">
    <label v-if="variant === 'dropzone'" :for="inputId" :class="dropzoneClasses">
      <div class="flex flex-col items-center justify-center text-gray-700 dark:text-gray-400 pt-5 pb-6">
        <svg class="w-8 h-8 mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    <div v-else class="flex flex-col items-center justify-center w-full h-64 bg-gray-50 dark:bg-gray-700 border border-dashed border-gray-400 dark:border-gray-500 rounded-lg">
      <div class="flex flex-col items-center justify-center text-gray-700 dark:text-gray-400 pt-5 pb-6">
        <svg class="w-8 h-8 mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
