...
export default {
  ...
  computed: {
    ...
    radioClasses() {
      const baseClasses =
        'w-4 h-4 bg-gray-100 border-gray-300 rounded-full focus:ring-2 focus:outline-none focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 appearance-none'
    ...
    labelClasses() {
      ...
      if (this.variant === 'card') {
        const baseCardClasses =
          'inline-flex items-center justify-between w-full p-5 bg-white dark:bg-gray-800 border rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700'
